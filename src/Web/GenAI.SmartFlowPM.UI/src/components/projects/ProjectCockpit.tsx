...
import { FolderOpen, Calendar, User, Clock, Search, Filter, Plus, MoreVertical, Edit, Eye, X, Flag, Building2, CheckCircle, XCircle, AlertCircle, PlayCircle, PauseCircle, DollarSign, Users, BarChart3 } from 'lucide-react';
